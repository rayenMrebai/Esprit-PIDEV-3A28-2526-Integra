...
$dbName = 'db_sym';    // nom de ta base de données (celle de ton projet Java)
$dbUser = 'root';         // ton utilisateur MySQL
$dbPass = '';             // ton mot de passe (vide par défaut sous XAMPP)
...
foreach ($tables as $table) {
    ...
    try {
        ...
        echo "⚠️ Skipping table '$table' : " . $e->getMessage() . "\n";
        continue;
    }
