...
final class ProjectController extends AbstractController
{
    ...
    public function exportExcelAll(ExcelExportService $excelService, UserAccountRepository $userRepo): Response
    {
        $projects = $this->projectRepository->findAll();
    ...
    public function exportExcelSingle(int $projectId, ExcelExportService $excelService, UserAccountRepository $userRepo): Response
    {
        $project = $this->projectRepository->find($projectId);
        if (!$project) {
            throw $this->createNotFoundException('Projet non trouvé');
